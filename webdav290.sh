...
echo $yellow
figlet -f future "Galaxi Cyber Anonymous"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"MrN0name"$cyan" ~/GCA"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"MiSetya"$cyan" ~/GCA"$white
read -p " ╰─$ " target2
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author   : MR.N0N4M3			"
echo $purple"TEAM   : Galaxi Cyber Anonymous"
echo $white"Suported  : All member GCA"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] Allah SWT "
echo $cyan"[+] Mr.Nonic & Dr.unknown "
echo $cyan"[+] Team Galaxi Cyber Anonymous "
echo $cyan"[+] All Member [G.C.A] "
echo $red"##########################$green" WELCOME "$red###########################"
